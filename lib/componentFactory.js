...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.rule:
      ...
      var size = (element.attr('size')) || 1;
      return format('<table %s class="%s"><tbody><tr><td height="'+size+'px" style="border-collapse:collapse;font-size:'+size+'px;line-height:'+size+'px;">&#xA0;</td></tr></tbody></table>', attrs, classes.join(' '), inner);
